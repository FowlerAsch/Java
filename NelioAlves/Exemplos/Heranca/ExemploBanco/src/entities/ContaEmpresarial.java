...
public class ContaEmpresarial extends Conta{
	...
	public void saque(double quantidade) { //Sobreposição do método de saque da classe conta
		super.saque(quantidade); //utiliza toda operação feita no método saque em conta e adiciona uma nova operação escrita em conta Empresarial 
		// ou seja, vai retirar 5 da classe conta e mais 2 da nova operação feita em contaEmpresarial 
		saldo -= 2.0;
	}
